...
import 'package:flutter_face_demo/screens/dialogs/dialog_animation_wrapper.dart';
import 'package:flutter_face_demo/screens/dialogs/dialog_face_fake.dart';
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void onLatestImageAvailable(CameraImage _cameraImage) async {
    ...
    if (_maskDetectionService
        .detectMask(ImageUtils.cropFace(_cameraImage, _listFace[0]))) {
    ...
    if (qualityScore > 700 && !_isSpoofing) {
      ...
      if (_user != null) {
        ...
        if (await _faceAntiSpoofingService
                .antiSpoofing(ImageUtils.cropFace(_cameraImage, _listFace[0])) <
            0.90) {
          warningMsg = "Giả mạo";
        } else {
